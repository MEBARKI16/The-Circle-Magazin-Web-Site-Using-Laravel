    ...
    200: {
     ...
     <div class="swiper mySwiper-lemission2">
      ...
      200: {
        ...
        <button type="button" class="btn btn-lg" style="width:30%;margin:50px 50px;background-color:#1b1464;color:white">Voir toutes les news</button>
  </section>

  <script src="{{asset('js/swiper-bundle.min.js')}}"></script>
  <link href="{{asset('css/swiper-bundle.min.css')}}" rel="stylesheet">
  <link href="{{asset('css/lesnews.css')}}" rel="stylesheet">
@endsection