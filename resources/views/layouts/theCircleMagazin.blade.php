                          ...
                          <div class="card-body card-magazin" >
                              <h5 class="card-title p-t-h text-center" style="color:#1b1464;font-family: 'LinotypeBanjomanText Bold', sans-serif;">Fintech, la digitalisation
                                ...
                                <nav class="nav navhome nav-pills nav-fill navx p-5">
                                    <a class="nav-item nav-link navhome1" href="{{route('lemission')}}">L’EMISSION</a>
                                    <div class="separateur2"></div>
                                    <a class="nav-item nav-link navhome2" href="{{route('lesdossiers')}}">LES DOSSIERS</a>
                                    <div class="separateur2"></div>
                                    <a class="nav-item nav-link navhome3" href="{{route('lentretien')}}">L’ENTRETIEN</a>
                                    <div class="separateur2"></div>
                                    <a class="nav-item nav-link navhome4 " href="{{route('lesnews')}}">LES NEWS</a>
                                    <div class="separateur2"></div>
                                    <a class="nav-item nav-link navhome5 " href="{{route('lespodcasts')}}">LES PODCASTS</a>
                                    <div class="separateur2"></div>
