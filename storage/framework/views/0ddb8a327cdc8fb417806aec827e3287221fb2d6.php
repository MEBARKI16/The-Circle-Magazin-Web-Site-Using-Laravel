...
<body>
    ...
    <nav class="nav nav-pills nav-justified d-flex justify-content-center justify-content-lg-between p-2 border-bottom text-center">
      ...
      <a class="nav-link" style="margin:auto;" href="#"><img class="logo" src="<?php echo e(asset('img/The-Circle-LOGO.svg')); ?>" alt=""></a>
      <a class="nav-link" style="margin:auto;" href="#"><button class="bouton bt"><?php echo e(__('acceuil.My Circle')); ?></button></a>
    </nav>
    <main>
            ...
            <div class="card ombre" style="width: 100%;">
                <div class="card bg-dark text-white img1" style="border:none;">
                    ...
                    <img class="card-img bg-i" src="<?php echo e(asset('img/AI_Image.jpg')); ?>" alt="Card image">
                    <div class="card-img-overlay" style="width:100%;height:100%">
                        <nav class="nav nav-pills nav-fill navx p-1 nav-img text-center justify-content-center">
                            <div class="bt" ><button class="bouton" style="background-color:white;color:#1b1464;border:2px solid;border-color:#1b1464;font-weight: bold;">Archives</button></div>
                                  ...
                                  <div>
                                          <nav class="card-body">
                                                  ...
                                                  <li><a href="<?php echo e(route('languageConverter','ar')); ?>">AR</a></li>
                                                    <li><a href="<?php echo e(route('languageConverter','en')); ?>">EN</a></li>
                          ...
                          <div class="card-body" style="width:30%;margin-left:5%;margin-top:12%">
                              <h5 class="card-title p-t-h" style="margin-bottom:30px;color:#1b1464;font-family: 'LinotypeBanjomanText Bold', sans-serif;">Fintech, la digitalisation
                                  au service de la finance</h5>
                                  <p class="card-text p-t-i" style="margin-bottom:60px;color:#1b1464">Les technologies appliquées à la finance
                                      permettent de diversifier l’offre bancaire
                                      et de voir émerger de nouveaux acteurs.</p>
                                      <a href="#" class="btn btn-primary bouton2"><i class="fa-sharp fa-solid fa-play"></i>   Je m’abonne</a>
                                    </div>
...
</html><?php /**PATH C:\wamp64\www\the-circle-magazin-project\resources\views/acceuil.blade.php ENDPATH**/ ?>